...
<head>
	...
	<link rel = "stylesheet" type = "text/css" href="css/abuManage.css">
...
<body>
	...
	<div class="main" style="margin-left: 500px;">
         ...
         <a href="<?php echo base_url('index.php/Home/contain');?>">Contain</a>
...
<div class="row4">
	<div class="container" style="border-width: 1">
		...
		<div class="row">
			...
			<div class="col-md-7">
				<p style="text-align: left ;margin-top: 70px;">Best Exprerience start with my time </p>
			</div>
		</div>
		<br>
		<div class="row">
			<div class="col-md-7">
				<p style="text-align: right ;margin-top: 70px;">Best Exprerience start with my first time </p>
			</div>
			<div class="col-md-5">
		...
		<div class="row">
			...
			<div class="col-md-7">
				<p style="text-align: left ;margin-top: 70px;">Best Exprerience start with my last time </p>
			</div>
		</div>
		<br>
		<div class="row">
			<div class="col-md-7">
				<p style="text-align: right ;margin-top: 70px;">Best Exprerience start with my endless time </p>
			</div>
			<div class="col-md-5">
				<img src="<?php echo base_url('assets\image\user1.png');?>"style="border-radius: 50%;width:150px;height:150px">
			</div>
